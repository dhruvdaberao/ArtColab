...
export const getStoredDisplayName = () => (typeof window === 'undefined' ? '' : localStorage.getItem(GUEST_DISPLAY_NAME_STORAGE_KEY)?.trim() ?? '');
...
export const resolveSessionDisplayName = (user: SessionUser | null | undefined) => {
